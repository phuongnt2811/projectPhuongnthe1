                ...
                <div class="home-table">
                    <div class="box">
                        ...
                        <div class="table-details" style="margin: 15px 0">
                            <a 
                            <a style="color: #081D45; background:#4070f4; border: 1px solid #2697FF; border-radius: 5px; padding: 5px; " href="list-class-student-student" role="All student">List All student</a>
                            <p name = "classId" style="margin: 15px 0">
                                Class: 
                                <c:forEach items="${listC}" var ="A">
                                    <a style="color: #081D45; background:#E4E9F7; border: 1px solid #2697FF; border-radius: 5px; padding: 5px;" href="filterclassSTUDENT?classId=${A.id}" role="button">${A.name}</a>
                                </c:forEach>
                            </p>
