...
public class addStudentInClass extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        ClassStudent classStudent = ClassStudent.builder().id(-1).classId(classId).className(className).studentId(studentId).studentName(studentName).studentCode(studentCode).build();
