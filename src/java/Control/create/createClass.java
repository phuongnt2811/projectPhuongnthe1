...
public class createClass extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Classes classes = Classes.builder().id(-1).name(name).startdate(startdate).endate(endate)
                .teacherId(teacherId).courseId(courseId).teacherName(teacherName).courseName(courseName).build();
